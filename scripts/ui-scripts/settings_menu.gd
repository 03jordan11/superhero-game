...
const HUD_LABELS := {&"always_show_health": "Always Show Health", &"always_show_stamina": "Always Show Stamina", &"always_show_experience": "Always Show Level / XP", &"show_minimap": "Show Minimap"}
