...
const FIELDS := ["_path","_waypoints","_path_index","_current_id","_pause_remaining","_crossing_active","walk_speed","lane_offset","spacing_speed_limit","crossing_wait_seconds","waypoint_arrival_distance","completed_destinations","skin_tone_index","model_variant_index","hair_style_index","hair_color_index"]
