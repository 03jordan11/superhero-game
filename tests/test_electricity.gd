...
func run() -> void:
	...
	check(powers.progression.is_implemented("electricity", 1), "Reactive Shock is implemented")
	check(powers.progression.is_implemented("electricity", 2), "Thunderstorm is implemented")
	check(powers.progression.is_implemented("electricity", 3), "Lightning Strike is implemented")
	shared.update_power(0.1, input())
