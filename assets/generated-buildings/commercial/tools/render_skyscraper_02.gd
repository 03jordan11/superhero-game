...
func run() -> void:
	...
	var asset: Node3D = load("res://assets/generated-buildings/commercial/commercial_skyscraper_02.tscn").instantiate()
	...
	var shots := [
		["day",132,Vector3(100,83,-160),Vector3(0,55,0)],
		["entrance",38,Vector3(18,12,-50),Vector3(0,5,0)],
		["roof",38,Vector3(25,136,-30),Vector3(0,108,0)],
		["night",132,Vector3(100,83,-160),Vector3(0,55,0)]
	]
	for shot in shots:
		...
		viewport.get_texture().get_image().save_png("res://artifacts/skyscraper_02/" + shot[0] + ".png")
	print("SKYSCRAPER_02_RENDERED: day, entrance, roof, night")
	quit()
